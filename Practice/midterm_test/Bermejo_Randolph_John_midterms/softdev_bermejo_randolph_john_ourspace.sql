...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2015 at 10:55 AM
...
--
-- Database: `softdev_bermejo_randolph_john_ourspace`
--
CREATE DATABASE IF NOT EXISTS `softdev_bermejo_randolph_john_ourspace` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `softdev_bermejo_randolph_john_ourspace`;
...
(12223, 'Randy', 'S', 'Bermejo', 'M', '2015-03-02 09:54:18', 'Makati City', '828-2819', '0913211323');
...
(23131, 12223, 'Randolph Bermejo', 'Hello World!', '2015-03-02 09:55:02');
