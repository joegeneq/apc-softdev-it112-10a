...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2015 at 04:08 AM
...
INSERT INTO `doctor` (`id`, `doctor_name`, `contact_no`, `email`) VALUES
(1, 'Dr.Franz Guzman', '09125724123', 'franzching@gmail.com');
...
CREATE TABLE IF NOT EXISTS `history` (
  ...
  `recurrence_area` varchar(255) NOT NULL,
...
INSERT INTO `history` (`id`, `dates`, `surgery`, `treatment`, `recurrence_area`, `response`, `patient_id`) VALUES
(2, '2015-04-15', 'Subcutaneous Mastectomy', 'Doxorubicin  and Cyclophosphamide  (AC)', 'sa', 'asa', 1);
...
CREATE TABLE IF NOT EXISTS `medical_record` (
  ...
  `bone_scan` varchar(255) NOT NULL,
  `lab_rep` varchar(255) NOT NULL,
  ...
  KEY `fk_medical_record_doctor_id_idx` (`doctor_id`)
...
INSERT INTO `medical_record` (`id`, `patient_id`, `doctor_id`, `breast_cancer_id`, `surgery_id`, `diagnosis_id`, `stages_id`, `breast_panel_id`, `histolgic_grading_id`, `ki_67_id`, `treatment_id`, `mammogram`, `ultrasound`, `ct_scan`, `bone_scan`, `lab_rep`, `result`) VALUES
(1, 1, 1, 1, 3, 4, 3, 2, 1, 1, 6, '', '', '', '', '', 'wery'),
(2, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', ''),
(3, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', ''),
(10, 1, 1, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'images/10906172_427222510764440_8387312931106586471_n.jpg', '', '', '', '', 'dsds'),
(11, 1, 1, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'images/10947318_1594435957457380_8673881435850955083_n.jpg', '', '', '', '', ''),
(12, 2, 1, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'images/a5.jpg', 'images/a7.jpg', 'images/a3.jpg', 'images/brestpanel.jpg', 'images/e7.jpg', ''),
(13, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', ''),
(14, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', ''),
(15, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', ''),
(16, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `patient` (
  ...
  `patient_g` varchar(255) NOT NULL,
  `patient_p` varchar(255) NOT NULL,
  `patient_lmp` varchar(255) NOT NULL,
...
INSERT INTO `patient` (`id`, `patient_lname`, `patient_fname`, `patient_mname`, `patient_address`, `patient_family_history`, `patient_menarche`, `patient_history`, `patient_g`, `patient_p`, `patient_lmp`, `patient_allergy`, `patient_dx`, `patient_nodes`, `patient_hgr`, `patient_ngr`, `patient_stage`, `patient_er`, `patient_pr`, `patient_her_two_m`, `patient_k_67`, `patient_metastic`, `patient_date`, `patient_age`, `patient_dob`, `patient_tel`, `patient_cell_no`) VALUES
(1, 'Cacao', 'Joy', 'Alfaro', 'Pque City', 'aa', 'aa', '0', '0', '0', '', 'aa', 'aa', 'aa', 'aa', 'aaaa', 'aa', 'aa', 'aa', 'aa', 'aa', 'aa', '0000-00-00', 20, 'aa', 'aa', '09175382739'),
(2, 'Chua', 'Anton', 'Coco', 'hk', 'fy', 'osa', '0', '0', '0', '', 'vh', 'v', 'j', 'o', 'bkbk', 'fyufu', 'bkiho', 'vufy', 'nihno', 'cftc', 'nono', '0000-00-00', 49, 'nln', 'gdcg', '09175382916');
...
(2, '2rsrdgf', 'Breast Panel', '2015-04-15', '2015-04-16', 2),
(4, 'sample', 'test', '2015-04-15', '2015-04-16', 2);
...
--
ALTER TABLE `history`
  ADD CONSTRAINT `history_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `medical_record`
  ...
  ADD CONSTRAINT `fk_medical_record_doctor_id_idx` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
